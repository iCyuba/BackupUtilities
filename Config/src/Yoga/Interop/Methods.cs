...
using static BackupUtilities.Config.Yoga.Interop.YGUnit;
...
public static unsafe partial class Methods
{
    ...
    [DllImport("yoga", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern bool YGNodeGetAlwaysFormsContainingBlock([NativeTypeName("YGNodeConstRef")] void* node);
